function renderPopup(content, popup, innerTab) {
  ...
  innerTab &&
    popup.appendChild(renderInnerTab(gTabSelect.value(), checkLogin.get()));
...
function renderText(text) {
  // class: text
  const productName =
    text.find((i) => i.id == "title") &&
    text.find((i) => i.id == "title").title.toLowerCase();
  return createElement({
    type: "div",
    className: "text",
    child: text.map((txt) => {
        ...
        return createElement({
          child: [
            createElement({
              type: "p",
              className: "title",
              text: `Thông tin ${productName}`,
            }),
            createElement({
              type: "ul",
              child: txt.info.map((i) =>
                createElement({ type: "li", text: i })
              ),
            }),
          ],
        });
        ...
        return createElement({
          child: [
            createElement({
              type: "p",
              className: "title",
              text: `Ý nghĩa phong thủy của ${productName}`,
            }),
  ...
  return createElement({
    ...
    child: video.map((vid) => {
      ...
      return createElement({
        ...
        events: {
          click: () => {
            renderPopup({ playVideo: vid }, popup);
          },
        },
        child: [
          createElement({
            type: "img",
            attributes: { src: getYtbImg(vid), alt: "loi" },
          }),
          title,
        ],
      });
      ...
      createElement({
        ...
        child: [
          ...
          createElement({
            ...
            attributes: {
              style:
                "--border-width: 1px; --button-background: var(--background);",
            },
            events: {
              mousedown: (e) => {
              ...
              mouseup: (e) => {
                findParentTag(e.target, "button")?.classList.remove("select");
              },
            },
            child: [
              createElement({
                type: "div",
                child: [createElement({ type: "p", text: "Hủy bỏ" })],
              }),
            ],
          }),
        ],
            ...
            child: [
              ...
              createElement({
                ...
                events: {
                  ...
                  mouseup: (e) => {
                    findParentTag(e.target, "button")?.classList.remove(
                      "select"
                    );
                  },
                },
                child: [
                  createElement({
                    type: "div",
                    child: [createElement({ type: "p", text: "Tải lên" })],
                  }),
                ],
              }),
            ],
